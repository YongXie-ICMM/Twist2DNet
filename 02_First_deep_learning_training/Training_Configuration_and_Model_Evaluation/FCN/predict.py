...
def parse_args():
    ...
    parser.add_argument("--weights-path", default="./save_weights/fcn_model.pth", help="segmentation weights path")
...
def get_segmentation_result(args):
    ...
    # create model
    model = fcn_resnet50(aux=aux, num_classes=args.num_classes+1)
