...
def parse_args():
    parser = argparse.ArgumentParser(description="pytorch FCN predict")
    # exclude background
    ...
    parser.add_argument("--weights-path", default="./save_weights/deeplabv3_model.pth", help="segmentation weights path")
...
def get_segmentation_result(args):
    ...
    # create model
    model = deeplabv3_resnet50(aux=aux, num_classes=args.num_classes+1)
