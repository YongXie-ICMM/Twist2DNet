...
def parse_args():
    parser = argparse.ArgumentParser(description="pytorch LRASPP predict")
    # exclude background
    ...
    parser.add_argument("--weights-path", default="./save_weights/lraspp_model.pth", help="segmentation weights path")
...
def get_segmentation_result(args):
    ...
    # create model
    model = lraspp_mobilenetv3_large(args.num_classes + 1)
